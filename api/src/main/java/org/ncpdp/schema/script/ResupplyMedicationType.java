...
public class ResupplyMedicationType {
    ...
    protected List<ResupplyMedicationType.Refills> refills;
     ...
     * 
     */
    public List<ResupplyMedicationType.Refills> getRefills() {
        if (refills == null) {
            refills = new ArrayList<ResupplyMedicationType.Refills>();
        }
        return this.refills;
    }
