...
public class RxChangePrescribedMedicationType {
    ...
    protected List<RxChangePrescribedMedicationType.Refills> refills;
     ...
     * 
     */
    public List<RxChangePrescribedMedicationType.Refills> getRefills() {
        if (refills == null) {
            refills = new ArrayList<RxChangePrescribedMedicationType.Refills>();
        }
        return this.refills;
    }
