 ...
 *         &lt;element ref="{http://www.ncpdp.org/schema/SCRIPT}Refills" maxOccurs="2"/>
...
public class PrescribedMedicationType {
    ...
    protected List<RefillsType> refills;
     ...
     * 
     */
    public List<RefillsType> getRefills() {
        if (refills == null) {
            refills = new ArrayList<RefillsType>();
        }
        return this.refills;
    }
