...
public class RefillRequestPrescribedMedicationType {
    ...
    protected List<RefillRequestPrescribedMedicationType.Refills> refills;
     ...
     * 
     */
    public List<RefillRequestPrescribedMedicationType.Refills> getRefills() {
        if (refills == null) {
            refills = new ArrayList<RefillRequestPrescribedMedicationType.Refills>();
        }
        return this.refills;
    }
