...
public class RefillResponseDispensedMedicationType {
    ...
    protected List<RefillResponseDispensedMedicationType.Refills> refills;
     ...
     * 
     */
    public List<RefillResponseDispensedMedicationType.Refills> getRefills() {
        if (refills == null) {
            refills = new ArrayList<RefillResponseDispensedMedicationType.Refills>();
        }
        return this.refills;
    }
