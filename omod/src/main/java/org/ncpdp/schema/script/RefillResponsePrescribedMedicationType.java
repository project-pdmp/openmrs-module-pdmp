...
public class RefillResponsePrescribedMedicationType {
    ...
    protected List<RefillResponsePrescribedMedicationType.Refills> refills;
     ...
     * 
     */
    public List<RefillResponsePrescribedMedicationType.Refills> getRefills() {
        if (refills == null) {
            refills = new ArrayList<RefillResponsePrescribedMedicationType.Refills>();
        }
        return this.refills;
    }
