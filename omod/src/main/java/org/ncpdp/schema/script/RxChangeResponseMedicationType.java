...
public class RxChangeResponseMedicationType {
    ...
    protected List<RxChangeResponseMedicationType.Refills> refills;
     ...
     * 
     */
    public List<RxChangeResponseMedicationType.Refills> getRefills() {
        if (refills == null) {
            refills = new ArrayList<RxChangeResponseMedicationType.Refills>();
        }
        return this.refills;
    }
