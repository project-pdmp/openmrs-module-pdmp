...
public class RxChangeDispensedMedicationType {
    ...
    protected List<RxChangeDispensedMedicationType.Refills> refills;
     ...
     * 
     */
    public List<RxChangeDispensedMedicationType.Refills> getRefills() {
        if (refills == null) {
            refills = new ArrayList<RxChangeDispensedMedicationType.Refills>();
        }
        return this.refills;
    }
